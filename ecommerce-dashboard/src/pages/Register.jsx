...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f5f7] font-sans flex items-center justify-center px-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col gap-5">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center justify-center gap-2 w-full bg-gray-900 hover:bg-gray-700 disabled:opacity-60 disabled:cursor-not-allowed active:scale-95 text-white text-sm font-semibold py-3 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md mt-1"
            >
              {loading
                ? <span className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                : <><ArrowRightIcon /> Create Account</>
              }
            </button>
