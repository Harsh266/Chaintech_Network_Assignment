...
function CartItem({ item, onIncrease, onDecrease, onRemove }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 p-4 flex gap-4 items-center group">
      {/* Product image */}
      <div className="w-24 h-24 shrink-0 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center overflow-hidden">
        <img
          src={item.image}
          alt={item.title}
    ...
    <div className="min-h-screen bg-[#f4f5f7] font-sans">
      ...
      <div className="bg-white border-b border-gray-100 shadow-sm">
        <div className=" mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <a href="/products" className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-900 font-medium transition-colors">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-7">
        ...
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-28 gap-3 text-center">
            <CartBagIcon />
            <p className="text-lg font-semibold text-gray-600 mt-2">Your cart is empty</p>
            <p className="text-sm text-gray-400">Add some products to get started</p>
            <a href="/products" className="mt-4 flex items-center gap-2 bg-gray-900 text-white text-sm font-semibold px-6 py-3 rounded-xl hover:bg-gray-700 transition-all">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <div className="w-full lg:w-80 shrink-0">
              <div className="bg-white rounded-2xl shadow-sm p-5 flex flex-col gap-4 sticky top-24">
                ...
                <div className="flex flex-col gap-2.5 text-sm text-gray-600">
                  ...
                  {shipping > 0 && (
                    <p className="text-xs text-gray-400 bg-amber-50 text-amber-600 px-3 py-1.5 rounded-lg">
                ...
                <button
                  ...
                  className="w-full bg-gray-900 hover:bg-gray-700 active:scale-95 text-white font-semibold py-3 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md text-sm"
                >
                  Checkout →
                </button>
