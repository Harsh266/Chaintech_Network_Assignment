...
export default function Navbar() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      setUrgent(remaining < 60000) // red under 1 min
    ...
    <nav className="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/dashboard" className="flex items-center gap-1 shrink-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={logout}
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 hover:text-red-600 active:scale-95 transition-all duration-200"
            >
              <LogoutIcon />
            ...
            <button
              className="md:hidden flex flex-col gap-1 p-2 rounded-xl hover:bg-gray-100 transition-colors"
              onClick={() => setMenuOpen(o => !o)}
            >
              <span className={`block w-5 h-0.5 bg-gray-700 transition-all duration-200 ${menuOpen ? "rotate-45 translate-y-1.5" : ""}`} />
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-gray-100 py-3 flex flex-col gap-1">
            ...
            {timeLeft > 0 && (
              <div className={`flex items-center gap-1.5 px-4 py-2 text-xs font-semibold rounded-xl mx-0
